package com.explodeman.castles.constants;

public interface IConst {
    double START_GEO_V = 49.282940;
    double START_GEO_V1 = 30.672263;
    float START_GEO_ZOOM = 5f;

    String KEY_CASTLES = "key_castles";
    String KEY_ONE_CASTLE = "key_one_castle";
